@testset "Card" begin
    ...
    @test isequal(
        showfields(Card("", "a comment string")),
        (
            "", "a comment string", "",
            "        a comment string                                                        ",
        )
    ...
    @test isequal(
        showfields(Card("", missing, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("COMMENT", "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("COMMENT", missing, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("COMMENT", "a value string", "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("HISTORY", "a history string")),
        (
    ...
    @test isequal(
        showfields(Card("HISTORY", missing, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("HISTORY", "a history string", "a comment string")),
        (
    ...
    #  create Value card with boolean value, fixed-format
    @test isequal(
        showfields(Card("BOOL", true; fixed = true)),
        (
            "BOOL", true, "",
            "BOOL    =                    T                                                  ",
        )
    ...
    @test isequal(
        showfields(Card("BOOL", true, fixed = false)),
        (
            "BOOL", true, "",
            "BOOL    = T                                                                     ",
        )
    ...
    @test isequal(
        showfields(Card("BOOL", true, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("BOOL", true, "a comment string", fixed = false)),
        (
            "BOOL", true, "a comment string",
            "BOOL    = T                    / a comment string                               ",
        )
    ...
    @test isequal(
        showfields(Card("INTEGER", 12345; fixed = true)),
        (
            "INTEGER", 12345, "",
            "INTEGER =                12345                                                  ",
        )
    ...
    @test isequal(
        showfields(Card("INTEGER", 12345; fixed = false)),
        (
            "INTEGER", 12345, "",
            "INTEGER = 12345                                                                 ",
        )
    ...
    @test isequal(
        showfields(Card("INTEGER", 12345, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("INTEGER", 12345, "a comment string", fixed = false)),
        (
            "INTEGER", 12345, "a comment string",
            "INTEGER = 12345                / a comment string                               ",
        )
    ...
    @test isequal(
        showfields(Card("LONG_INT", -467374636747637647347374734737437)),
        (
    ...
    @test isequal(
        showfields(Card("LONG_INT", -467374636747637647347374734737437, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("FLOAT_32", 1.2345f0)),
        (
            "FLOAT_32", 1.2345f0, "",
            "FLOAT_32=               1.2345                                                  ",
        )
    ...
    @test isequal(
        showfields(Card("FLOAT_32", 1.2345f0; fixed = true)),
        (
            "FLOAT_32", 1.2345f0, "",
            "FLOAT_32=               1.2345                                                  ",
        )
    ...
    #  create Value card with 32-bit float fixed value, test fixed format = true
    @test isequal(
        showfields(Card("FLOAT_32", 1.2345f0; fixed = false)),
        (
            "FLOAT_32", 1.2345f0, "",
            "FLOAT_32= 1.2345                                                                ",
        )
    ...
    @test isequal(
        showfields(Card("FLOAT_32", 1.2345f0, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("FLOAT_32", 1.2345f0, "a comment string"; fixed = false)),
        (
            "FLOAT_32", 1.2345f0, "a comment string",
            "FLOAT_32= 1.2345               / a comment string                               ",
        )
    ...
    #  create Value Card with 32-bit float value, fixed-format
    @test isequal(
        showfields(Card("FLOAT_32", 1.2345f6)),
        (
            "FLOAT_32", 1.2345f6, "",
            "FLOAT_32=             1.2345E6                                                  ",
        )
    ...
    @test isequal(
        showfields(Card("FLOAT_64", 1.2345)),
        (
            "FLOAT_64", 1.2345, "",
            "FLOAT_64=               1.2345                                                  ",
        )
    ...
    #  create Value Card with 64-bit float value, fixed-format
    @test isequal(
        showfields(Card("FLOAT_64", 1.2345; fixed = true)),
        (
            "FLOAT_64", 1.2345, "",
            "FLOAT_64=               1.2345                                                  ",
        )
    ...
    @test isequal(
        showfields(Card("FLOAT_64", 1.2345; fixed = false)),
        (
            "FLOAT_64", 1.2345, "",
            "FLOAT_64= 1.2345                                                                ",
        )
    ...
    #  create Value Card with 64-bit float value, fixed-format
    @test isequal(
        showfields(Card("FLOAT_64", 1.2345, "a comment string")),
        (
    ...
    #  create Value Card with 64-bit float value, free-format
    @test isequal(
        showfields(Card("FLOAT_64", 1.2345, "a comment string"; fixed = false)),
        (
            "FLOAT_64", 1.2345, "a comment string",
            "FLOAT_64= 1.2345               / a comment string                               ",
        )
    ...
    #  create Value Card with 64-bit float value, fixed-format
    @test isequal(
        showfields(Card("FLOAT_64", 1.2345e6)),
        (
            "FLOAT_64", 1.2345e6, "",
            "FLOAT_64=             1.2345D6                                                  ",
        )
    ...
    @test isequal(
        showfields(Card("CPLX_INT", 8 + 9im)),
        (
            "CPLX_INT", 8 + 9im, "",
            "CPLX_INT= (8, 9)                                                                ",
        )
    ...
    #  create Value Card with complex 64-bit integer value
    @test isequal(
        showfields(Card("CPLX_INT", 8 + 9im, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("CPLX_F32", 8.1f0 + 9.2f0im)),
        (
    ...
    #  create Value Card with complex 32-bit float value
    @test isequal(
        showfields(Card("CPLX_F32", 8.1f0 + 9.2f0im, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("CPLX_F64", 8.1 + 9.2im)),
        (
            "CPLX_F64", 8.1 + 9.2im, "",
            "CPLX_F64= (8.1, 9.2)                                                            ",
        )
    ...
    #  create Value Card with complex 64-bit float value
    @test isequal(
        showfields(Card("CPLX_F64", 8.1 + 9.2im, "a comment string")),
        (
    ...
    #  create Value Card with complex 32-bit float value
    @test isequal(
        showfields(Card("CPLX_F32", 8.1f0 + 9im)),
        (
    ...
    #  create Value Card with complex 32-bit float value
    @test isequal(
        showfields(Card("CPLX_F32", 8.1f0 + 9im, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("CPLX_F64", 8.1 + 9im)),
        (
            "CPLX_F64", 8.1 + 9.0im, "",
            "CPLX_F64= (8.1, 9.0)                                                            ",
        )
    ...
    #  create Value Card with complex 64-bit float and integer value
    @test isequal(
        showfields(Card("CPLX_F64", 8.1 + 9im, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("CPLX_F64", 8 + 9.2im)),
        (
            "CPLX_F64", 8.0 + 9.2im, "",
            "CPLX_F64= (8.0, 9.2)                                                            ",
        )
    ...
    #  create Value Card with complex integer and 64-bit float value
    @test isequal(
        showfields(Card("CPLX_F64", 8 + 9.2im, "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("STRING", "a value string")),
        (
    ...
    #  create Value Card with a string value
    @test isequal(
        showfields(Card("STRING", "a value string", "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("STRING", "Kelley O'Hara")),
        (
    ...
    @test isequal(
        showfields(Card("STRING", "Kelley O'Hara", "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("STRING", "Kelley O'Hara", "a comment string with single quote '")),
        (
    ...
    @test isequal(
        showfields(Card("STRING", repeat("-", 58), "a truncated comment", slash = 72, truncate = true)),
        (
    ...
    @test isequal(
        showfields(Card("longcom", "19 character string", "a comment string", lpad = 0, rpad = 0)),
        (
    ...
    @test isequal(
        showfields(Card("continue", "part of a long string")),
        (
    ...
    @test isequal(
        showfields(Card("continue", "part of a long string", "with comment")),
        (
    ...
    card = Card(
        "longcom", repeat("Kelley O'Hara ", 4), repeat("long comment ", 10), slash = 42,
        lpad = 1, fixed = false
    )
    @test isequal(
        showfields(card[1]),
    ...
    card = Card(
        "WHATEVER", "SuperCalibrationParameters_XXXX_YYYY_ZZZZZ_KK_01_02_03)-AAABBBCCC.n.h5 " *
    ...
    @test isequal(
        showfields(Card("XTENSION", "BINTABLE", "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("XTENSION", "IMAGE", "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("XTENSION", "TABLE", "a comment string")),
        (
    ...
    @test isequal(
        showfields(Card("HIERARCH", "abc def gh ijklmn", -99.9, "")),
        (
    ...
    @test isequal(
        showfields(Card("HIERARCH", "abc def gh ijklmn_-", -99.9, "[m] abcdef ghijklm nopqrstu vw xyzab")),
        (
